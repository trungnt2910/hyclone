 ...
 */
#ifndef __HAIKU_ERRORS_H__
#define __HAIKU_ERRORS_H__
...
#define HAIKU_POSIX_E2BIG			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 1)
#define HAIKU_POSIX_ECHILD			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 2)
#define HAIKU_POSIX_EDEADLK			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 3)
#define HAIKU_POSIX_EFBIG			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 4)
#define HAIKU_POSIX_EMLINK			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 5)
#define HAIKU_POSIX_ENFILE			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 6)
#define HAIKU_POSIX_ENODEV			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 7)
#define HAIKU_POSIX_ENOLCK			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 8)
#define HAIKU_POSIX_ENOSYS			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 9)
#define HAIKU_POSIX_ENOTTY			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 10)
#define HAIKU_POSIX_ENXIO			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 11)
#define HAIKU_POSIX_ESPIPE			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 12)
#define HAIKU_POSIX_ESRCH			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 13)
#define HAIKU_POSIX_EFPOS			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 14)
#define HAIKU_POSIX_ESIGPARM		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 15)
#define HAIKU_POSIX_EDOM			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 16)
#define HAIKU_POSIX_ERANGE			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 17)
#define HAIKU_POSIX_EPROTOTYPE		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 18)
#define HAIKU_POSIX_EPROTONOSUPPORT	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 19)
#define HAIKU_POSIX_EPFNOSUPPORT	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 20)
#define HAIKU_POSIX_EAFNOSUPPORT	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 21)
#define HAIKU_POSIX_EADDRINUSE		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 22)
#define HAIKU_POSIX_EADDRNOTAVAIL	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 23)
#define HAIKU_POSIX_ENETDOWN		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 24)
#define HAIKU_POSIX_ENETUNREACH		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 25)
#define HAIKU_POSIX_ENETRESET		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 26)
#define HAIKU_POSIX_ECONNABORTED	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 27)
#define HAIKU_POSIX_ECONNRESET		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 28)
#define HAIKU_POSIX_EISCONN			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 29)
#define HAIKU_POSIX_ENOTCONN		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 30)
#define HAIKU_POSIX_ESHUTDOWN		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 31)
#define HAIKU_POSIX_ECONNREFUSED	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 32)
#define HAIKU_POSIX_EHOSTUNREACH	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 33)
#define HAIKU_POSIX_ENOPROTOOPT		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 34)
#define HAIKU_POSIX_ENOBUFS			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 35)
#define HAIKU_POSIX_EINPROGRESS		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 36)
#define HAIKU_POSIX_EALREADY		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 37)
#define HAIKU_POSIX_EILSEQ			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 38)
#define HAIKU_POSIX_ENOMSG			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 39)
#define HAIKU_POSIX_ESTALE			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 40)
#define HAIKU_POSIX_EOVERFLOW		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 41)
#define HAIKU_POSIX_EMSGSIZE		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 42)
#define HAIKU_POSIX_EOPNOTSUPP		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 43)
#define HAIKU_POSIX_ENOTSOCK		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 44)
#define HAIKU_POSIX_EHOSTDOWN		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 45)
#define HAIKU_POSIX_EBADMSG			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 46)
#define HAIKU_POSIX_ECANCELED		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 47)
#define HAIKU_POSIX_EDESTADDRREQ	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 48)
#define HAIKU_POSIX_EDQUOT			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 49)
#define HAIKU_POSIX_EIDRM			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 50)
#define HAIKU_POSIX_EMULTIHOP		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 51)
#define HAIKU_POSIX_ENODATA			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 52)
#define HAIKU_POSIX_ENOLINK			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 53)
#define HAIKU_POSIX_ENOSR			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 54)
#define HAIKU_POSIX_ENOSTR			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 55)
#define HAIKU_POSIX_ENOTSUP			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 56)
#define HAIKU_POSIX_EPROTO			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 57)
#define HAIKU_POSIX_ETIME			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 58)
#define HAIKU_POSIX_ETXTBSY			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 59)
#define HAIKU_POSIX_ENOATTR			B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 60)
#define HAIKU_POSIX_ENOTRECOVERABLE	B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 61)
#define HAIKU_POSIX_EOWNERDEAD		B_TO_POSIX_ERROR(B_POSIX_ERROR_BASE + 62)

/* B_NO_MEMORY (0x80000000) can't be negated, so it needs special handling */
#ifdef B_USE_POSITIVE_POSIX_ERRORS
#	define HAIKU_POSIX_ENOMEM		B_POSIX_ENOMEM
#else
#	define HAIKU_POSIX_ENOMEM		B_NO_MEMORY
#endif

/* POSIX errors that can be mapped to BeOS error codes */
#define HAIKU_POSIX_EACCES			B_TO_POSIX_ERROR(B_PERMISSION_DENIED)
#define HAIKU_POSIX_EINTR			B_TO_POSIX_ERROR(B_INTERRUPTED)
#define HAIKU_POSIX_EIO				B_TO_POSIX_ERROR(B_IO_ERROR)
#define HAIKU_POSIX_EBUSY			B_TO_POSIX_ERROR(B_BUSY)
#define HAIKU_POSIX_EFAULT			B_TO_POSIX_ERROR(B_BAD_ADDRESS)
#define HAIKU_POSIX_ETIMEDOUT		B_TO_POSIX_ERROR(B_TIMED_OUT)
#define HAIKU_POSIX_EAGAIN 			B_TO_POSIX_ERROR(B_WOULD_BLOCK)	/* SysV compatibility */
#define HAIKU_POSIX_EWOULDBLOCK 	B_TO_POSIX_ERROR(B_WOULD_BLOCK)	/* BSD compatibility */
#define HAIKU_POSIX_EBADF			B_TO_POSIX_ERROR(B_FILE_ERROR)
#define HAIKU_POSIX_EEXIST			B_TO_POSIX_ERROR(B_FILE_EXISTS)
#define HAIKU_POSIX_EINVAL			B_TO_POSIX_ERROR(B_BAD_VALUE)
#define HAIKU_POSIX_ENAMETOOLONG	B_TO_POSIX_ERROR(B_NAME_TOO_LONG)
#define HAIKU_POSIX_ENOENT			B_TO_POSIX_ERROR(B_ENTRY_NOT_FOUND)
#define HAIKU_POSIX_EPERM			B_TO_POSIX_ERROR(B_NOT_ALLOWED)
#define HAIKU_POSIX_ENOTDIR			B_TO_POSIX_ERROR(B_NOT_A_DIRECTORY)
#define HAIKU_POSIX_EISDIR			B_TO_POSIX_ERROR(B_IS_A_DIRECTORY)
#define HAIKU_POSIX_ENOTEMPTY		B_TO_POSIX_ERROR(B_DIRECTORY_NOT_EMPTY)
#define HAIKU_POSIX_ENOSPC			B_TO_POSIX_ERROR(B_DEVICE_FULL)
#define HAIKU_POSIX_EROFS			B_TO_POSIX_ERROR(B_READ_ONLY_DEVICE)
#define HAIKU_POSIX_EMFILE			B_TO_POSIX_ERROR(B_NO_MORE_FDS)
#define HAIKU_POSIX_EXDEV			B_TO_POSIX_ERROR(B_CROSS_DEVICE_LINK)
#define HAIKU_POSIX_ELOOP			B_TO_POSIX_ERROR(B_LINK_LIMIT)
#define HAIKU_POSIX_ENOEXEC			B_TO_POSIX_ERROR(B_NOT_AN_EXECUTABLE)
#define HAIKU_POSIX_EPIPE			B_TO_POSIX_ERROR(B_BUSTED_PIPE)

/* new error codes that can be mapped to POSIX errors */
#define B_BUFFER_OVERFLOW			B_FROM_POSIX_ERROR(HAIKU_POSIX_EOVERFLOW)
#define B_TOO_MANY_ARGS				B_FROM_POSIX_ERROR(HAIKU_POSIX_E2BIG)
#define B_FILE_TOO_LARGE			B_FROM_POSIX_ERROR(HAIKU_POSIX_EFBIG)
#define B_RESULT_NOT_REPRESENTABLE	B_FROM_POSIX_ERROR(HAIKU_POSIX_ERANGE)
#define B_DEVICE_NOT_FOUND			B_FROM_POSIX_ERROR(HAIKU_POSIX_ENODEV)
#define B_NOT_SUPPORTED				B_FROM_POSIX_ERROR(HAIKU_POSIX_EOPNOTSUPP)
